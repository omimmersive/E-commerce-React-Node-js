  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "The Hairwigs - E-Commerce Website",
        name: "The Hairwigs | React eCommerce Admin Dashboard",
        description:
          "The Hairwigs : React Grocery & Organic Food Store e-commerce Admin Dashboard",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
